...
function ModalPlanes({ onCerrar, productoCount }: any) {
  ...
  const planes = [
    ...
    },
    {
      ...
      periodo: '/mes',
      limite: '30 productos',
      features: ['30 fotos de productos', 'Catálogo online', 'Pedidos por WhatsApp', 'Soporte prioritario'],
      recomendado: true,
      color: 'green',
      msg: msgPro,
    },
    {
      ...
      periodo: '/mes',
      limite: 'Ilimitado',
      features: ['Productos ilimitados', 'Catálogo online', 'Pedidos por WhatsApp', 'Soporte prioritario', 'Acceso completo a todas las funciones'],
      color: 'orange',
      msg: msgFull,
    },
  ];
    ...
    return (
      <div className="min-h-screen bg-[#f0faf4] font-['DM_Sans']">
        ...
        <header className="sticky top-0 z-50 bg-white backdrop-blur-md border-b-2 border-orange-100 shadow-sm">
          <nav className="max-w-6xl mx-auto px-6 py-4 flex justify-between items-center">
            <div className="flex items-center gap-2">
              <img src="/logo.png" alt="Vendemos Fácil" className="h-10 w-auto object-contain" onError={e => { e.target.style.display='none'; }} />
              ...
              {[
                {
                  ...
                  features: ['5 productos con foto', 'Catálogo online con link', 'Pedidos por WhatsApp', 'Ideal para empezar'],
                  color: 'gray', cta: 'Empezar gratis',
                },
                {
                  nombre: 'Pro', precio: '$9.990', periodo: '/mes',
                  features: ['30 productos con foto', 'Catálogo online con link', 'Pedidos por WhatsApp', 'Soporte prioritario'],
                  color: 'green', cta: 'Contratar Pro', recomendado: true,
                },
                {
                  nombre: 'Full', precio: '$19.990', periodo: '/mes',
                  features: ['Productos ilimitados', 'Catálogo online con link', 'Pedidos por WhatsApp', 'Soporte prioritario', 'Acceso completo'],
        ...
        <footer className="text-center py-8 text-sm text-gray-400 bg-gray-900 border-t border-gray-800">
          © {new Date().getFullYear()} Vendemos Fácil — Hecho con ❤️ en Chile
        </footer>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-gray-50 font-['DM_Sans']">
        ...
        <header className="sticky top-0 z-50 bg-white border-b border-gray-200 shadow-sm">
          <nav className="max-w-6xl mx-auto px-6 py-4 flex justify-between items-center">
            <div className="flex items-center gap-2">
              <img src="/logo.png" alt="Vendemos Fácil" className="h-9 w-auto object-contain" onError={e => { e.target.style.display='none'; }} />
              <span className="text-lg font-black text-[#16a34a] font-['Fraunces']">Vendemos Fácil</span>
            </div>
                  ...
                  <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
                    {productos.map(p => (
                      <div key={p.id} className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition group">
                        ...
                        <div className="h-40 overflow-hidden bg-gradient-to-br from-green-50 to-orange-50 flex items-center justify-center relative">
                          {p.imagen
                            ? <img src={p.imagen} alt={p.nombre} className="w-full h-full object-cover" />
                            : <Camera className="w-10 h-10 text-gray-300" />}
                          <button
